...
const goAiAssesment = () => {
    router.push('/ai-learning-assesment')
}

const goAiRolePlay = () => {
    router.push('/ai-role-play-chat')
}

const moduleAiRolePlay1 = ref([
    {
...
const moduleAiRolePlay2 = ref([
    {
        thumbnail: '/Rectangle 39 (5) (copy).png',
        title: 'Menjelaskan Akar Masalah ke Product Manager',
        duration: '5 menit',
        category: 'Easy',
    },
    {
        thumbnail: '/Rectangle 39 (6) (copy).png',
        title: 'Menganalisis Data Log untuk Menemukan Penyebab Bug',
        duration: '5 menit',
        category: 'Easy',
    },
    {
        thumbnail: '/Rectangle 39 (7) (copy).png',
        title: 'Menghadapi API Error di Tengah Pelaksanaan Sprint',
        duration: '5 menit',
        category: 'Easy',
    },
    {
        thumbnail: '/Rectangle 39 (8) (copy).png',
        title: 'Menentukan Prioritas Task Saat Deadline Bertumpuk',
        duration: '5 menit',
        category: 'Easy',
    }
])

const moduleAiRolePlay3 = ref([
    {
        thumbnail: '/Rectangle 39 (9) (copy).png',
        title: 'Memimpin Rapat Evaluasi dengan Sikap Terbuka dan Solutif',
        duration: '5 menit',
        category: 'Easy',
    },
    {
        thumbnail: '/Rectangle 39 (10) (copy).png',
        title: 'Mengarahkan Tim Saat Terjadi Perubahan Prioritas Proyek',
        duration: '5 menit',
        category: 'Easy',
    },
    {
        thumbnail: '/Rectangle 39 (7) (copy).png',
        title: 'Mengambil Tanggung Jawab Saat Kesalahan Terjadi di Tim',
        duration: '5 menit',
        category: 'Easy',
    },
    {
        thumbnail: '/Rectangle 39 (11) (copy).png',
        title: 'Membangun Budaya Growth Mindset di Dalam Tim',
        duration: '5 menit',
        category: 'Easy',
    },
])
...
<template>
    ...
    md:[--gH:50%]">
        <h1 class="font-bold text-center mx-auto pt-10 text-[35px] line-clamp-2 max-w-[36ch]">
            ...
            Bareng Nusa AI yang Paham Cara Kamu Berkembang
        </h1>
        <div class="flex flex-row gap-10">
            <img src="/AI Learning Assesment 2.png" alt="">
            <img src="/AI Learning Path (HASIL) 2.png" alt="">
        </div>
    </section>
    ...
    <section class="assesment pt-10">
        <div class="flex justify-between w-[75%] bg-gradient-to-r from-[#f5f2ff] p-5 rounded-xl to-[#e6ebff] mx-auto">
            ...
            <Button class="bg-[#5476FF] hover:bg-[#5476FF] cursor-pointer" @click="goAiAssesment">Mulai
                Assesment</Button>
        </div>
    </section>

    <section class="melatih relative overflow-visible">
        <h1 class="font-bold text-center mx-auto pt-10 text-[30px] line-clamp-2 max-w-[50ch]">
    ...
    <section class="ai-role-play mt-10 ps-25">
        <div class="flex gap-5 items-center">
            <h1 class="text-[30px] font-bold">Interpersonal & Communication</h1>
            <p class="text-xl text-[#5476ff]">Lihat Semua</p>
        </div>
        <div class="flex flex-row gap-5 mt-5">
            <div v-for="(card, idx) in moduleAiRolePlay1" :key="idx"
                ...
                <div class="flex justify-between mt-5">
                    ...
                    <Button
                        class="w-50 flex justify-center items-center bg-[#5476FF] border border-[#5476FF] hover:bg-[#5476FF] cursor-pointer"
                        @click="goAiRolePlay">
                        Mulai Role Play
                    </Button>
                </div>
    ...
    <section class="ai-role-play mt-10 ps-25">
        <div class="flex gap-5 items-center">
            <h1 class="text-[30px] font-bold">Problem-solving & Critical thinking</h1>
            <p class="text-xl text-[#5476ff]">Lihat Semua</p>
        </div>
        <div class="flex flex-row gap-5 mt-5">
            <div v-for="(card, idx) in moduleAiRolePlay2" :key="idx"
                class="border border-[#E6EBFF] shadow-[0_4px_4px_0_rgba(230,235,255,0.25)] w-90 p-3 rounded-xl flex flex-col">
                <img :src="card.thumbnail" alt="" class="rounded-lg w-full object-cover h-50" />
    ...
    <section class="ai-role-play mt-10 ps-25">
        <div class="flex gap-5 items-center">
            <h1 class="text-[30px] font-bold">Leadership & Growth Mindset</h1>
            <p class="text-xl text-[#5476ff]">Lihat Semua</p>
        </div>
        <ScrollArea class="w-full pb-5 rounded-md">
            <div class="flex flex-row gap-5 mt-5">
                <div v-for="(card, idx) in moduleAiRolePlay3" :key="idx"
                    class="border border-[#E6EBFF] shadow-[0_4px_4px_0_rgba(230,235,255,0.25)] w-90 p-3 rounded-xl flex flex-col">
                    <img :src="card.thumbnail" alt="" class="rounded-lg w-full object-cover h-50" />
